...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen" href="httpss://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" />
	<link rel="stylesheet" type="text/css" media="screen" href="./css/font-awesome.css" />
	<script   src="httpss://code.jquery.com/jquery-2.2.4.js"   integrity="sha256-iT6Q9iMJYuQiMWNd9lDyBUStIq/8PuOW33aOqmvFpqI="   crossorigin="anonymous"></script>
	<script src="httpss://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js" integrity="sha384-0mSbJDEHialfmuBBQP6A4Qrprq5OVfW37PRR3j5ELqxss1yVqOtnepnHVP9aJ7xS" crossorigin="anonymous"></script>
...
(function($) {
    ...
    */
    ...
    function loadTableData(page, page_size,sort,order) {
		...
		//console.log("https://mwsu-webdev.xyz/api/api.php/products?order="+sort+"&page=" + page + "," + page_size);
    ...
    function getTotalPages(){
        $.get("https://mwsu-webdev.xyz/api/api.php/products")
	...
	function addCartItem(item){
		...
		$.post("https://mwsu-webdev.xyz/api/api.php/shopping_cart/",postData);
	}
